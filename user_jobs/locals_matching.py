"""Matching helpers for locals® listings and user filters.

Like SCHOBA and the other brokers, locals® carries no reliable district
vocabulary shared with Immowelt/ProPotsdam — a filter here is just
rooms/area/Kaltmiete bounds.
"""
...
def _num(value: Any) -> Optional[float]:
    ...
    try:
        ...
        return locals_parser.parse_decimal(value)
...
def format_notification(listing: Dict[str, Any], lang: str = "uk") -> str:
    return locals_parser.format_listing_message(listing, lang=lang)
