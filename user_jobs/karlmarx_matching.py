"""Matching helpers for Karl Marx listings and user filters.

No district vocabulary here either — a filter is just rooms/area/Warmmiete
bounds. Price is Warmmiete (warm rent), not Kaltmiete, so it is not treated
as interchangeable with the other broker sites' price bounds.
"""
...
def _num(value: Any) -> Optional[float]:
    ...
    try:
        ...
        return karlmarx_parser.parse_decimal(value)
