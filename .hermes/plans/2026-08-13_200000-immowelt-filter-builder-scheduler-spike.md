...
**Cases:**
1. Potsdam, rent, apartment+house, source without `Tauschwohnung`, sorted newest first. Confirmed input URL from Artem: `https://www.immowelt.de/classified-search?distributionTypes=Rent&estateTypes=House,Apartment&locations=AD08DE8638&projectTypes=Stock,New_Build,Flatsharing&order=DateDesc&m=homepage_new_search_classified_search_result`.
